...
namespace AJ
{
    [CustomEditor(typeof(AJ.CompositeBehaviour))]
           ...
           // check for behaviours
            ...
            else
            {
                ...
                for (int i = 0; i < cb.behaviours.Length; i++)
                {
                    ...
                    cb.behaviours[i] =
                        (FlockBehaviour) EditorGUILayout.ObjectField(cb.behaviours[i], typeof(FlockBehaviour), false, GUILayout.MinWidth(60f));
